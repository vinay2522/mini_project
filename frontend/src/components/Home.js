    ...
    <Section id="home" title="Home">
      <div className="space-y-8">
        ...
        <section className="hero gradient-bg text-white p-4 sm:p-8 rounded-lg mb-8">
          <h2 className="text-2xl sm:text-4xl font-bold mb-4 text-shadow">
        ...
        {/* Book Now Section */}
        <section className="book-now-section bg-white p-4 sm:p-8 rounded-lg shadow-lg mb-8 flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 mb-4 md:mb-0">
            <h3 className="text-2xl sm:text-3xl font-bold mb-4 text-red-600">Emergency Booking</h3>
            <p className="text-base sm:text-lg mb-4 text-gray-700">
              Need an ambulance urgently? Book now and get immediate assistance.
            </p>
            <button
              onClick={handleBookNow}
              className="bg-red-600 text-white px-6 py-2 rounded hover:bg-red-700 cursor-pointer hover-scale inline-block text-sm sm:text-base"
            >
              Book Now
            </button>
          </div>
        ...
        <Element name="about">
          <Section id="about" title="About Us" className="mb-8 rounded-lg shadow-lg p-4 sm:p-8 bg-gray-50">
            <div className="text-center">
              <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-blue-600">About Us</h2>
            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-6">
              ...
              <div className="max-w-sm p-4 rounded-md shadow-md border-t-4 border-blue-500 bg-white">
                <h3 className="text-lg sm:text-xl font-semibold mb-2 text-gray-800">Our Mission</h3>
              ...
              <div className="max-w-sm p-4 rounded-md shadow-md border-t-4 border-green-500 bg-white">
                <h3 className="text-lg sm:text-xl font-semibold mb-2 text-gray-800">What We Offer</h3>
              ...
              <div className="max-w-sm p-4 rounded-md shadow-md border-t-4 border-orange-500 bg-white">
                <h3 className="text-lg sm:text-xl font-semibold mb-2 text-gray-800">Why Choose Us?</h3>
                <div className="mt-4 flex items-center gap-4">
                  <FaAmbulance className="text-3xl sm:text-4xl text-red-600" />
                  <p className="text-sm sm:text-base text-gray-600">Modern and well-equipped ambulances for any emergency.</p>
                </div>
                <div className="mt-4 flex items-center gap-4">
                  <FaUserMd className="text-3xl sm:text-4xl text-red-600" />
                  <p className="text-sm sm:text-base text-gray-600">Expert medical staff ensuring quality care.</p>
                </div>
                <div className="mt-4 flex items-center gap-4">
                  <FaPhoneAlt className="text-3xl sm:text-4xl text-red-600" />
                  <p className="text-sm sm:text-base text-gray-600">24/7 helpline for round-the-clock assistance.</p>
                </div>
              </div>
            </div>

            <div className="mt-8 text-center">
              <h3 className="text-xl sm:text-2xl font-bold mb-4 text-blue-600">Who We Are</h3>
              <p className="text-base sm:text-lg mb-6 text-gray-700">
              ...
              />
              <p className="text-base sm:text-lg font-medium mt-6 text-gray-800">
