...
const DownloadButton = ({ icon: Icon, text, link }) => (
  <a href={link} className="flex items-center justify-center bg-red-600 text-white py-3 px-6 rounded-lg hover:bg-red-700 transition-colors duration-300">
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
        <p className="text-center mb-6">Get our mobile app for quick and easy access to emergency services.</p>
